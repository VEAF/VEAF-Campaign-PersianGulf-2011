...
if veafCombatZone then 
	...
	veafCombatZone.AddZone(
		VeafCombatZone.new()
			:setMissionEditorZoneName("Zone-ZULU")
			:setFriendlyName("ZULU - attack on Fujairah")
            :setBriefing("An enemy armor battalion is progressing through the mountains to Fujairah airport.\n" ..
                         "\n" ..
                         "The allied quick reaction force ZULU, on alert at the base, is racing to face them.\n" ..
                         "It'll reach its assigned defensive position (the city of Minha), in about 30 minutes.\n" ..
                         "You must interdict the Minha defense in order to help ZULU achieve its mission.\n" ..
                         "\n" ..
						 "Warning - insurgent armed with rifles and portable SAM have been spotted in the zone !\n")
	)
    :activate()
end
